...
public final class URLFactory {
    ...
    public String getAPITicketNewCommentUrl(String ticketId) {
        return appendPath(API_PATH.append("ticket").append(ticketId).append("comment")).toString();
    }
    ...
    public String getAPIQueueUrl(String queueId) {
        return appendPath(API_PATH.append("queue").append(queueId), "format", "l").toString();
    }

    public String getAPIQueueCustomFieldsUrl(String queueId) {
        return appendPath(API_PATH.append("queue").append(queueId).append("customfields"), "format", "l").toString();
    }

    public String getAPIQueueTicketCustomFieldsUrl(String queueId) {
