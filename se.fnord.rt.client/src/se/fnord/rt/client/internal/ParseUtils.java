...
public final class ParseUtils {
    ...
    static String[] splitLines(final String data) {
        return LINE_SPLITTER.split(data);
    }
    ...
    static void parseAttributes(final String attributeString, final Map<String, String> attributes) {
        final String[] lines = splitLines(attributeString);
    ...
    public static String alignValue(final int alignment, final String value) {
        ...
        final String[] lines = splitLines(trimmed);
        if (lines.length == 1)
            return lines[0];
